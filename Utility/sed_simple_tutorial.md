# sed 简明教程
转载于 陈皓 [coolshell](https://coolshell.cn/articles/9104.html)
...
1. 正则为：`This is my ([^,]*),.*is (.*)`
2. 匹配为：`This is my (cat),……….is (betty)`
3. 然后：`\1`就是cat，`\2`就是betty
...
接下来，我们需要了解一下Hold Space的概念，我们先来看5个命令：
...
![](images/sed_simple_tutorial/sed_demo.jpg)
...
![](images/sed_simple_tutorial/sed_demo_00.jpg)
